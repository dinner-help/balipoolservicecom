...
export function Footer() {
  ...
  const companyInfo = [
    ...
    { label: "WhatsApp", href: "https://wa.me/6282323011656", external: true },
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-20">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            {/* Phone */}
            <a href="tel:+6282323011656" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
              <Phone className="h-5 w-5" />
              <span className="text-sm">+62 823 2301 1656</span>
            </a>
