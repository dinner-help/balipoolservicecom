        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 mb-6">
              <a href="tel:+62123445566" className="flex items-start gap-3 text-sm text-muted-foreground hover:text-primary transition-colors group">
                <Phone className="h-4 w-4 mt-0.5 group-hover:scale-110 transition-transform" />
                <span>+62 123 445 566</span>
              </a>
