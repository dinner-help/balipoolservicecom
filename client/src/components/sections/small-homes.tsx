  ...
  const homeOwnerBenefits = [
    {
      ...
      description: "Starting from just IDR 2.9M/month - professional pool care that fits your family budget. No job is too small for us.",
    },
    {
      icon: Home,
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-muted/30 rounded-xl p-6">
                ...
                <div className="mt-6 pt-6 border-t">
                  <div className="text-2xl font-bold text-primary">IDR 2.9M/month</div>
        ...
        <div className="bg-muted/30 rounded-2xl p-8 md:p-10 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Starting at IDR 2.9M/month, it's more affordable than you think - especially when you factor in the cost of DIY chemicals, equipment repairs from improper maintenance, and your valuable weekend time.
              </p>
            </div>
            <div>
