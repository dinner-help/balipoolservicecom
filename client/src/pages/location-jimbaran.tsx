  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Elite pool maintenance in Jimbaran for luxury resorts, beachfront villas & infinity pools. VIP service, discreet technicians, white-glove standards. Call: +62 823-2301-1656" />
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild data-testid="button-call-jimbaran">
                  <a href="https://wa.me/6282323011656?text=Hello!%20I%27m%20interested%20in%20luxury%20pool%20service%20in%20Jimbaran">
