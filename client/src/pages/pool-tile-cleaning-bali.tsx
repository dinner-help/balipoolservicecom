  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional pool tile cleaning in Bali. Remove calcium scale, algae stains & waterline buildup from your pool tiles. Restore shine to villa, hotel & resort pools. From IDR 1,125,000. Call: +62 823-2301-1656" />
      </Helmet>
