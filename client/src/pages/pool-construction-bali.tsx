  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Build your dream pool in Bali with Bali's trusted pool construction team. Villa pools, infinity pools, plunge pools, saltwater pools & more. Fixed pricing from IDR 70M, 10-step build process, 10+ years experience. Free quote: +62 823-2301-1656" 
        />
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="gap-2 bg-amber-600 hover:bg-amber-700" asChild data-testid="button-whatsapp-hero">
                  <a 
                    href="https://wa.me/6282323011656?text=Hi! I'm interested in building a new swimming pool in Bali."
                    target="_blank"
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" className="gap-2" asChild data-testid="button-whatsapp-cta">
                <a 
                  href="https://wa.me/6282323011656?text=Hi! I'd like a free quote for swimming pool construction in Bali."
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="h-5 w-5" />
