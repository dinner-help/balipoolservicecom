  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Commercial pool service in Bali for hotels, resorts, condos & large facilities. Multi-pool management, compliance documentation, 24/7 support, EU-certified chemicals. Trusted by 50+ Bali properties. Call: +62 823-2301-1656" />
      </Helmet>
