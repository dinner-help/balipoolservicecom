                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    <Button 
                      variant="destructive" 
                      className="gap-2"
                      onClick={() => window.open("https://wa.me/6282323011656?text=URGENT: I need emergency green pool cleaning service", "_blank")}
            ...
            <div className="my-16 p-8 rounded-2xl bg-gradient-to-br from-destructive/10 to-destructive/5 border-2 border-destructive/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  ...
                  variant="destructive"
                  className="gap-2"
                  onClick={() => window.open("https://wa.me/6282323011656?text=URGENT: I need green pool cleaning service", "_blank")}
