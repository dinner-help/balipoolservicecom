  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://balipoolservice.com/id" />
        <link rel="alternate" hreflang="en" href="https://balipoolservice.com/" />
        <link rel="alternate" hreflang="id" href="https://balipoolservice.com/id" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 relative">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <a 
                    href="https://wa.me/6282323011656?text=Halo! Saya ingin tanya tentang jasa perawatan kolam renang. Bisa kirim info harga dan paket?"
                    target="_blank"
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            ...
            <div className="text-center">
              ...
              <Button variant="outline" asChild data-testid="button-contact-area">
                <a 
                  href="https://wa.me/6282323011656?text=Halo! Apakah melayani area saya?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <section className="py-20 md:py-28 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
          <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a 
                  href="https://wa.me/6282323011656?text=Halo! Saya tertarik dengan jasa perawatan kolam renang. Bisa kirim detail paket dan harga?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="mr-2 h-5 w-5" />
