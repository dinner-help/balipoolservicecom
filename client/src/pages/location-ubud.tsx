  ...
  const faqs = [
    {
      ...
      answer: "Pool cleaning in Ubud starts from IDR 800,000/month for our Silver Package (1 visit/week). Our Gold Package is IDR 1,500,000/month for 2 visits/week, and Platinum is IDR 2,800,000/month for 2 visits/week. All chemicals and supplies included."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Professional pool cleaning in Ubud for highland villas, eco-resorts & jungle retreats. Organic-friendly chemicals, jungle debris specialists. From IDR 800K/month. WhatsApp: +62 823-2301-1656" />
