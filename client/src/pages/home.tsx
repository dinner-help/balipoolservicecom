  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Bali's most trusted pool cleaning & maintenance service. 500+ villas, hotels & homes. Weekly cleaning from IDR 800K/month — chemicals included, WhatsApp reports after every visit. Serving Canggu, Seminyak, Ubud & all of Bali. Call: +62 823-2301-1656" 
        />
        <meta 
          name="keywords" 
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button 
                ...
                onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27d%20like%20a%20quote%20for%20pool%20cleaning%20in%20Bali.", "_blank")}
      ...
      <section className="py-20 md:py-28 bg-white" id="services">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              From weekly pool maintenance to emergency algae rescue and equipment repairs. Every service includes certified chemicals and a WhatsApp report.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="hover-elevate border-2 hover:border-primary/50 transition-all">
              <CardContent className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27m%20interested%20in%20Weekly%20Pool%20Maintenance.", "_blank")}
                >
            ...
            <Card className="hover-elevate border-2 border-green-500 hover:border-green-400 transition-all">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Emergency Green Pool Recovery</h3>
                <p className="text-sm text-gray-600 mb-4">
                ...
                <div className="text-2xl font-bold text-green-600 mb-4">
                  From IDR 1,000,000<span className="text-sm font-normal text-gray-500">/treatment</span>
                </div>
                <Button 
                  className="w-full bg-green-600 hover:bg-green-700 text-white gap-2"
                  onClick={() => window.open("https://wa.me/6282323011656?text=URGENT!%20My%20pool%20has%20turned%20green.%20Need%20rescue%20service.", "_blank")}
                >
                  <FaWhatsapp className="h-4 w-4" />
                  Emergency Help
                </Button>
            ...
            <Card className="hover-elevate border-2 hover:border-primary/50 transition-all">
              <CardContent className="p-6">
                ...
                <Button 
                  className="w-full bg-black hover:bg-gray-800 text-white gap-2"
                  onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27m%20interested%20in%20Hotel%20Pool%20Service%20contract.", "_blank")}
                >
                  <FaWhatsapp className="h-4 w-4" />
                  Discuss Contract
                </Button>
            ...
            <Card className="hover-elevate border-2 hover:border-primary/50 transition-all">
              <CardContent className="p-6">
                ...
                <div className="text-2xl font-bold text-primary mb-4">
                  From IDR 1,000,000<span className="text-sm font-normal text-gray-500">/service</span>
                </div>
                <Button 
                  className="w-full bg-black hover:bg-gray-800 text-white gap-2"
                  onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%20need%20pool%20equipment%20repair.", "_blank")}
                >
                  <FaWhatsapp className="h-4 w-4" />
                  Request Repair
                </Button>
      ...
      <section className="py-20 md:py-28 bg-gray-50" id="service-areas">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <p className="text-center text-gray-500 mt-8">
            Don't see your area? We cover all of Bali! <a href="https://wa.me/6282323011656" className="text-primary hover:underline">WhatsApp us</a> your location.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Send your location and pool photos to <span className="font-semibold">+62 823-2301-1656</span>. We'll respond within hours.
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            <Button 
              size="lg"
              className="bg-black hover:bg-gray-800 text-white gap-2"
              onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27d%20like%20to%20get%20a%20pool%20service%20quote.%20Here%20are%20my%20pool%20details:", "_blank")}
            >
              <FaWhatsapp className="h-5 w-5" />
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-primary to-primary/80 text-white" id="contact">
        <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
          ...
          <Button 
            size="lg"
            className="bg-black hover:bg-gray-800 text-white gap-2 text-lg px-8 py-6"
            onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27d%20like%20a%20quote%20for%20pool%20service.%20Here%20are%20my%20pool%20details:", "_blank")}
          ...
          <p className="text-sm text-white/70 mt-6">
            WhatsApp: +62 823-2301-1656 • Available 24/7 for emergencies
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-sm text-gray-500 mb-6">For private villas & homes — small pools</p>
                <div className="text-4xl font-bold text-primary mb-2">From IDR 800,000</div>
                ...
                <Button 
                  className="w-full bg-black hover:bg-gray-800 text-white gap-2"
                  onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27m%20interested%20in%20the%20Silver%20Package.", "_blank")}
                >
                  <FaWhatsapp className="h-4 w-4" />
                  Get Silver Package
                </Button>
            ...
            <Card className="border-2 border-primary relative">
              ...
              <CardContent className="p-8 text-center">
                ...
                <p className="text-sm text-gray-500 mb-6">For rental villas & luxury homes — medium pools</p>
                <div className="text-4xl font-bold text-primary mb-2">From IDR 1,500,000</div>
                <p className="text-sm text-gray-500 mb-6">/month</p>
                <ul className="space-y-3 text-sm text-gray-600 mb-8 text-left">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                ...
                <Button 
                  ...
                  onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27m%20interested%20in%20the%20Gold%20Package.", "_blank")}
                >
                  <FaWhatsapp className="h-4 w-4" />
                  Get Gold Package
                </Button>
            ...
            <Card className="border-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-sm text-gray-500 mb-6">For estates & boutique hotels — large pools</p>
                <div className="text-4xl font-bold text-primary mb-2">From IDR 2,800,000</div>
                <p className="text-sm text-gray-500 mb-6">/month</p>
                <ul className="space-y-3 text-sm text-gray-600 mb-8 text-left">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                    <span>2 visits per week</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-primary flex-shrink-0" />
                ...
                <Button 
                  className="w-full bg-black hover:bg-gray-800 text-white gap-2"
                  onClick={() => window.open("https://wa.me/6282323011656?text=Hi!%20I%27m%20interested%20in%20the%20Platinum%20Package.", "_blank")}
                >
                  <FaWhatsapp className="h-4 w-4" />
