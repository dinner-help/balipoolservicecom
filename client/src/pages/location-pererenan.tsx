  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Expert pool cleaning in Pererenan for beachfront villas, surf retreats & eco-properties. Organic debris management, eco-friendly chemical options. From IDR 800K/month. Call: +62 823-4070-9041" />
      ...
      <main className="pt-14">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-black hover:bg-gray-800 text-white gap-2" asChild>
                  <a href="https://wa.me/6282340709041?text=Hello!%20I%20need%20pool%20service%20in%20Pererenan">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <Button className="w-full bg-black hover:bg-gray-800 text-white gap-2" asChild>
                    <a href="https://wa.me/6282340709041?text=Hi!%20I%20want%20the%20Silver%20package%20for%20Pererenan">
              ...
              <Card className="border-primary">
                <CardContent className="p-8 text-center">
                  ...
                  <Button className="w-full gap-2" asChild>
                    <a href="https://wa.me/6282340709041?text=Hi!%20I%20want%20the%20Gold%20package%20for%20Pererenan">
                      <FaWhatsapp className="h-4 w-4" />Get Quote
                    </a>
                  </Button>
                </CardContent>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <Button className="w-full bg-black hover:bg-gray-800 text-white gap-2" asChild>
                    <a href="https://wa.me/6282340709041?text=Hi!%20I%20want%20the%20Platinum%20package%20for%20Pererenan">
                      <FaWhatsapp className="h-4 w-4" />Get Quote
                    </a>
                  </Button>
                </CardContent>
        ...
        <section className="py-20 md:py-28 bg-primary text-white">
          <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
            ...
            <Button size="lg" className="bg-black hover:bg-gray-800 text-white gap-2" asChild>
              <a href="https://wa.me/6282340709041?text=Hi!%20I%20need%20pool%20service%20in%20Pererenan.">
                <FaWhatsapp className="h-5 w-5" />
