  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Professional hotel pool service in Bali. Multi-pool management, EU-certified chemicals, health audit documentation & digital service reports. Trusted by 50+ hotels and resorts. Platinum package from IDR 2,800,000/month. Call: +62 823-2301-1656" 
        />
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 relative">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <a 
                    href="https://wa.me/6282323011656?text=Hi! I'm inquiring about hotel/resort pool service. Can you send me information for our property?"
                    target="_blank"
              ...
              <Card className="max-w-3xl mx-auto bg-primary/5 border-primary/20">
                <CardContent className="p-8">
                  ...
                  <Button variant="outline" asChild data-testid="button-demo-dashboard">
                    <a 
                      href="https://wa.me/6282323011656?text=Hi! Can I see a demo of the digital dashboard and reporting system?"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
                ...
                >
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="pt-6">
                      ...
                      >
                        <a 
                          href={`https://wa.me/6282323011656?text=Hi! I'm interested in the ${pkg.name} plan for our hotel/resort. Can we schedule an assessment?`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
            ...
            <div className="text-center mt-12">
              ...
              <Button variant="outline" size="lg" asChild data-testid="button-custom-plan">
                <a 
                  href="https://wa.me/6282323011656?text=Hi! I need a custom service plan for our hotel/resort. Can we discuss our specific requirements?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
        ...
        <section className="py-20 md:py-28 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
          <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a 
                  href="https://wa.me/6282323011656?text=Hi! I'm interested in professional pool service for our hotel/resort. Can we schedule a property assessment?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="mr-2 h-5 w-5" />
