  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional pool vacuuming service in Bali. Remove sand, leaves, frangipani & tropical debris from pool floors. Included in all maintenance packages. For villas, hotels & homes. Call: +62 823-4070-9041" />
      </Helmet>
