  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Professional cold plunge installation in Bali for villas, gyms & spas. 7 types including stainless steel, concrete & commercial systems. Cooling, insulation & filtration included. Built for Bali's tropical climate. From IDR 14M. Call: +62 823-2301-1656" 
        />
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="gap-2 bg-cyan-600 hover:bg-cyan-700" asChild data-testid="button-whatsapp-hero">
                  <a 
                    href="https://wa.me/6282323011656?text=Hi! I'm interested in cold plunge installation in Bali."
                    target="_blank"
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" className="gap-2" asChild data-testid="button-whatsapp-cta">
                <a 
                  href="https://wa.me/6282323011656?text=Hi! I'd like to get a cold plunge installed in Bali. Can you provide a quote?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="h-5 w-5" />
