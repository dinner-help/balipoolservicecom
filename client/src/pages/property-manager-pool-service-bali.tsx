          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 relative">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <a 
                    href="https://wa.me/6282237565997?text=Hi! I'm a property manager interested in your agency pool service. Can you send me information about portfolio management and group pricing?"
                    target="_blank"
              ...
              <Card className="max-w-3xl mx-auto bg-primary/5 border-primary/20">
                <CardContent className="p-8">
                  ...
                  <Button variant="outline" asChild data-testid="button-schedule-demo">
                    <a 
                      href="https://wa.me/6282237565997?text=Hi! I'd like to schedule a demo of the portfolio dashboard for property managers."
                      target="_blank"
                      rel="noopener noreferrer"
                    >
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8">
                ...
                >
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="pt-6">
                      ...
                      >
                        <a 
                          href={`https://wa.me/6282237565997?text=Hi! I'm interested in the ${pkg.name} plan for my property management company. Can we discuss?`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
            ...
            <div className="text-center mt-12">
              ...
              <Button variant="outline" size="lg" asChild data-testid="button-custom-plan">
                <a 
                  href="https://wa.me/6282237565997?text=Hi! I need a custom plan for my property management company. Can we discuss our specific needs?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Phone className="mr-2 h-4 w-4" />
        ...
        <section className="py-20 md:py-28 bg-gradient-to-br from-primary/10 via-primary/5 to-background">
          <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a 
                  href="https://wa.me/6282237565997?text=Hi! I'm a property manager interested in your agency service. Can we discuss portfolio management and group pricing?"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp className="mr-2 h-5 w-5" />
