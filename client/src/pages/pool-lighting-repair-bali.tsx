  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Pool lighting repair & LED upgrade service in Bali. Fix broken underwater lights, replace old bulbs with energy-efficient LED, full electrical safety check. For villas & hotels. Call: +62 823-2301-1656" />
      </Helmet>
